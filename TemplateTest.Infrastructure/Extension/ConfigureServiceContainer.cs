...
using TemplateTest.Core.Implementation;
using TemplateTest.Core.Repository;
using TemplateTest.Core.Storage;
using TemplateTest.Domain.Entities;
using TemplateTest.Domain.Settings;
using TemplateTest.Infrastructure.Configs;
using TemplateTest.Infrastructure.Handlers;
...
using System.Text;
using IClientFactory = TemplateTest.Core.Contract.IClientFactory;
        ...
        public static void AddSwaggerOpenAPI(this IServiceCollection serviceCollection)
        {
            serviceCollection.AddSwaggerGen(setupAction =>
            {
                ...
                setupAction.SwaggerDoc(
                    ...
                    new OpenApiInfo()
                    {
                        Title = "TemplateTest Admin WebAPI",
                        Version = "1",
                        Description = "API Details for TemplateTest Admin",
                        Contact = new OpenApiContact()
                        {
                            Email = "okafori@theTemplateTestnetwork.com",
                            Name = "The TemplateTest Network",
                            Url = new Uri(" https://theTemplateTestnetwork.com")
                        },
        ...
        public static void AddCustomControllers(this IServiceCollection serviceCollection)
        {
            ...
            serviceCollection.Configure<ApiBehaviorOptions>(apiBehaviorOptions =>
                apiBehaviorOptions.InvalidModelStateResponseFactory = actionContext =>
                {
                    ...
                    return new BadRequestObjectResult(new Domain.Common.Response<IEnumerable<string>>("TemplateTest Validation Error", 400, errorList));
                });
        }
